...
#    https://app.powerbi.com/reportEmbed?reportId=41d9e0b4-9f3b-4c5c-8e40-e05bc99a8b77&autoAuth=true&ctid=e8df5f43-80c9-47f6-a040-4562dce73ccd
    st.markdown(
        """
   ...
   # st.area_chart(chart_data)
    ...
    new_df["Year"]= new_df["Year"].dt.date
     ...
     #data_nadal=new_df[new_df["Player"]=="Nadal R."]
     #data_nadal
