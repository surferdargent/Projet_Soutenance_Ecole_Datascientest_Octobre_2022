...
class Member:
    ...
    def sidebar_markdown(self):
        ...
        if self.github_url is not None:
            markdown += f' <a href={self.github_url} target="_blank"><img src="https://cdn-icons-png.flaticon.com/512/25/25231.png" alt="github" width="20" style="vertical-align: middle; margin-left: 5px"/></a> '
